...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        ...
        return (int) Math.floor((BufferPool.getPageSize() * 8 * 1.0) / (td.getSizeInBytes() * 8 + 1));
    ...
    public byte[] getPageData() {
        ...
        // padding
        int zerolen = BufferPool.getPageSize() - (header.length + td.getSizeInBytes() * tuples.length); //- numSlots * td.getSize();
